...
<script>
import queue from '@/pages/energyMulti/components/queue.vue'
...
export default {
  ...
  data() {
    return {
      labelName: '',
      toolGroups: [
        // [{ imgSrc: require("@/assets/img/jiduan/celue.png"), label: "多能互补策略生成", path: '/energyModle' },],
        // [{ imgSrc: require("@/assets/img/jiduan/巡航.png"), label: "源网荷储巡航", path: '/cruise' },],
        [{ imgSrc: require("@/assets/img/jiduan/tuopu1.png"), show: false, label: "拓  扑  自  动  辨  识", path: '/topology' },],
        [{ imgSrc: require("@/assets/img/jiduan/tiaokong.png"), show: false, label: "多  能  协  同  调  控", path: '/regulate' },],
        [{ imgSrc: require("@/assets/img/jiduan/huifu.png"), show: false, label: "应  急  供  电  恢  复", path: '/restoration' },],
        // [{ imgSrc: require("@/assets/img/jiduan/评估.png"), label: "可靠性和韧性评估", path: '/assessment' },],
        [{ imgSrc: require("@/assets/img/jiduan/shenduronghe.png"), show: false, label: "上一任务-态势感知", path: '/pingu' },],
        [{ imgSrc: require("@/assets/img/jiduan/shenduronghe.png"), show: false, label: "下一任务-实时响应", path: '/stereoStrategy' },],
  ...
  methods: {
    changeLableName(value) {
      ...
      switch (value) {
        case '/topology':
          this.labelName = '城市配电网拓扑自动辨识技术'
          break;
        case '/regulate':
          this.labelName = '基于igdt-cvar的应急调度策略'
          break;
        case '/restoration':
          this.labelName = '城市配电网储能优化配置和多能协调控制技术'
          break;
        default:
          break;
      }
