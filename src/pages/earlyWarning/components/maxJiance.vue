            ...
            <div class="maxdialog">
                <div class="dialog">
                    <div class="dialog_body">
                        <div class="dialog_title">故障检测参数选择</div>
                        <div class="body_main">
                            <el-form ref="form" :model="form" :rules="formRules" label-width="6vw">
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="丢失节点数" prop="nums">
                                            <el-input v-model="form.nums" placeholder=""></el-input>
                                        </el-form-item>
                                        <el-form-item label="训练次数" prop="sums">
                                            <el-input v-model="form.sums" placeholder=""></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="12">
                                        <el-form-item label="节点" prop="node">
                                            <el-input v-model="form.node" placeholder=""></el-input>
                                        </el-form-item>
                                        <el-form-item label="支路" prop="load">
                                            <el-input v-model="form.load" placeholder=""></el-input>
                                        </el-form-item>
        ...
        confirmTrue() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    this.$emit('MAXJICEDATA', this.form);
