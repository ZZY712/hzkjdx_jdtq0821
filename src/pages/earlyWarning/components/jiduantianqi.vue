            ...
            <div class="maxdialog">
                <div class="dialog">
                    <div class="dialog_body">
                        <div class="dialog_title">极端天气灾害下的配电网停电风险智能预警</div>
                        <div class="body_main">
                            <el-form ref="form" :model="form" :rules="formRules" label-width="6vw">
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="拉丁超立方采样数" prop="n_ori">
                                            <el-input v-model="form.n_ori" placeholder=""></el-input>
                                        </el-form-item>
                                        <el-form-item label="步长（间隔时间/分钟）" prop="tstep">
                                            <el-input v-model="form.tstep" placeholder=""></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="12">
                                        <el-form-item label=" k-medoids聚类数" prop="n_cut">
                                            <el-input v-model="form.n_cut" placeholder=""></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                            </el-form>
