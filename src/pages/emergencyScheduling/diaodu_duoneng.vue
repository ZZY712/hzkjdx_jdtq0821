      ...
      <div class="dialog">
        <div class="dialog_body">
          ...
          <el-form ref="form3" :model="form3" :rules="rules" label-width="120px">
            <el-row>
              <el-col :span="12">
                <el-form-item label="请选择拓扑" prop="params1">
                  <el-select v-model="form3.params1" placeholder="请选择拓扑方案" :style="{ width: '80%' }">
          ...
          <div class="dialog_title">
            {{ this.form3.params1 }}拓扑
          </div>
          <div>
            <img style="width: 25vw;height: 24vh;"
              :src="require('../../assets/img/jiduan/' + this.form3.params1 + '.png')" alt="">
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      defaultFormData: {},
      rules: {
        params1: [{ required: true, message: '请选择拓扑', trigger: 'blur' }],
      },
    }
  },
  mounted() {
