<template>
    <div id="topologyCardRight3" class="cardTopology" v-loading="loading" element-loading-text="任务未执行"
...
export default {
    ...
    methods: {
        updateChart() {
            ...
            this.chartInstances = [];
            let chartDom1 = document.getElementById('topologyCardRight3');
            if (chartDom1) {
        ...
        computerData(allData) {
            ...
            allData.data[6].date.forEach((items, index) => {
