...
<script>
import queue from '@/pages/emergencyScheduling/components/queue.vue'
...
export default {
  ...
  data() {
    return {
      labelName: '',
      toolGroups: [
        [{ imgSrc: require("@/assets/img/jiduan/celue.png"), show: false, label: "韧性提升", path: '/stereoStrategy' },],
        [{ imgSrc: require("@/assets/img/jiduan/pinggu1.png"), show: false, label: "可靠性和韧性评估", path: '/assessment' },],
        [{ imgSrc: require("@/assets/img/jiduan/shenduronghe.png"), show: false, label: "上一任务-应急调度", path: '/topology' },],
  ...
  methods: {
    changeLableName(value) {
      ...
      switch (value) {
        case '/stereoStrategy':
          this.labelName = '可移动式储能协同优化应急处置技术'
          break;
        case '/assessment':
          this.labelName = '网络动态重构的配电网大面积停电应急处置技术'
          break;
        default:
          break;
      }
