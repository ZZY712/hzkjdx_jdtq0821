        ...
        <div class="chart-container">
            <div class="ports">
                ...
                <div v-if="!isBigLoad" style="display: flex;position: relative">
                    <el-upload ref="upload" style="margin-left: 30%;margin-top: 1%;" class="upload-demo" :drag="true"
                        submit action="#" accept=".xlsx,.xls,.csv" :limit="parseInt('1')" :multiple="true"
                        :before-remove="beforeRemove" :auto-upload="false" :on-exceed="handleExceed"
                    ...
                    <el-button size="small" type="primary" style="height: 4vh;position: absolute;top: 1vh;right: 1vw;"
                        @click="submit" plain>上传</el-button>
                </div>
                <bigUpload v-if="isBigLoad" :formInline="formInline" />
            </div>
        </div>
    </div>
</template>
...
import bigUpload from './bigUpload.vue'
export default {
    components: {
        bigUpload
    },
